...
OUT = HERE / "data" / "p6a_match_gallita_candidates.tsv"
JOURNAL = HERE / "data" / "p6a_match_gallita_journal.tsv"
UA = {"User-Agent": "P6a-research/0.1 (preregistered study; max@gst.st)"}

QUERY = ('(dc.title any "memorie ricordi autobiografia diario confessioni") '
         'and (dc.language all "ita") and (dc.type all "monographie")')
