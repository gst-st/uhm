...
OUT = HERE / "data" / "p6a_match_ia_candidates.tsv"
JOURNAL = HERE / "data" / "p6a_match_ia_journal.tsv"
UA = {"User-Agent": "P6a-research/0.1 (preregistered study; max@gst.st)"}

Q = ('language:(ita) AND mediatype:(texts) AND (title:(memorie) OR '
     'title:(ricordi) OR title:(autobiografia) OR title:(diario) OR '
     'title:(confessioni))')
