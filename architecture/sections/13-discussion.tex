...
\begin{itemize}[leftmargin=1.5em,itemsep=1pt]
  \item \textbf{V0 --- emulation (exists).} \SYNARC{} on CPU/GPU: \DM{} in
        L1, Fano-sparse Strang kernel, all invariants verified. Discharges
        B2, B3, B4; demonstrates the logical architecture.
  \item \textbf{V1 --- in-memory (near-term).} A memristive Fano crossbar
        ...
        data-movement term.
  \item \textbf{V2 --- driven-dissipative (research).} An analogue, photonic,
