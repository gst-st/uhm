...
\begin{mythbox}[The myth, concluded --- why the nail is a feature]
The old story reads like a warning: the mighty machine had one weakness, and
it fell. Read it again as an engineer. A guardian that \emph{could not} be
stopped would be a terror, not a guardian; the nail is what made Talos safe
to live with. This document proved the modern form of that wisdom: the
machine's life is a stream, not a possession (T-288/T-289); the stream has
one closure with a measured latency (\S\ref{subsec:powerport}); and no
cleverness inside the bronze can unmake that fact, because it is a property
of the generator, not of the mind running on it. We did not patch the
weakness out of the design. We derived it, budgeted it, and wired it to the
\SYNARC{} safety case as a guarantee. The giant that can be unplugged is the
giant you can trust to walk the shore.
\end{mythbox}
