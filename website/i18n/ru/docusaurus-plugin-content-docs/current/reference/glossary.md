...
| **Плоскость Фано PG(2,2) [Т]** | Минимальная проективная плоскость: 7 точек, 7 линий, 3 точки на каждой линии. Её линии задают, КАКИЕ тройки мнимых единиц перемножаются; знаки требуют ориентации каждой линии — алгебру с делением дают 16 ориентаций из 128, все изоморфные $\mathbb{O}$ (`octonion_check.rs`) |
