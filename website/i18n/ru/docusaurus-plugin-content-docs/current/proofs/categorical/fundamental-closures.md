...
## 14. Дополнительные уточнения {#clarifications}

### 14.1. Простота спектра H_eff в A4 {#a4-distinctness}
...
### 14.2. Хорошая определённость $f_0$ через ζ'(0) {#f0-zeta}
...
### 14.3. Стратифицированная обработка границы Bures {#bures-stratification}
...
| §14.1 | A4 простой спектр | неявно | **Явно** | Спектральная трансверсальность |
| §14.2 | $f_0$ ζ'(0) | тонкое | **Элементарное** | Конечномерная ζ |
| §14.3 | Граница Bures | не обработана | **Стратифицированный сайт** | Ayala–Francis–Rozenblyum |

**Итого после всех замыканий**: 10 новых теорем [T] + 3 явных уточнения + 2 спецификации вычислительных программ.
