...
Плюс две находки, которых аудит не заказывал: $r_4 = 1/2$ — **тождество** теоремы 13.5 (не измеренный вход), а $\Sigma_0$ читается как **амплитудная** сумма (фазовое чтение калибровочно-зависимо). С ними замкнутая форма даёт $\varepsilon_\mathrm{eff} = 0{,}0569$ против петлевого $0{,}0587$ — $3\%$, причём минимизатор независимо воспроизвёл вакуумную структуру T-64 (конфайнмент $\varepsilon_{3\bar 3} \to 0$, электрослабое $\varepsilon_{\bar 3\bar 3} \to 0$). Оговорка, держащая *значение* в [С]: минимизация шла в $SU(3)$-ковариантном секторном анзаце (5 амплитуд); полный прогон по 21 амплитуде без анзаца — оставшаяся проверка.
:::
