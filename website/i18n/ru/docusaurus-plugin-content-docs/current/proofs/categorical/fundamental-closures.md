...
**L1 (Категориальная принудительность $\mathbb C^7$ и $G_2$).** Комбинация T-149 (минимальность плоскости Фано), T-82 (единственность BIBD(7,3,1) через Fisher + Veblen–Wedderburn), T-42a ($G_2$-жёсткость диссипатора Фано), T-120 ($M^4 = \mathbb R \times \Sigma^3$ из квантовой ЦПТ), T-151 ($D_{\min} = 2$ из Φ-порога), T-190 (нулеаксиоматическое категориальное замыкание). 12-шаговый Мост T-15 цепляет их:
...
1. **Интринсическая принудительность L2** (T-149 + T-82 + T-120 + T-151 + T-190): гарантирует, что L2 не является выбранной абстракцией.
