...
с единственной $\psi$-зависимой константой $B_\psi \approx 0{,}180$.
...
при $P_\rho = 0{,}45$. У полного потока вращение уводит живой аттрактор с
отрезка (≈13 %), но закон держится, потому что чистота вращения не видит:
$\mathrm{tr}(\Gamma[H,\Gamma]) \equiv 0$. В среднем же
