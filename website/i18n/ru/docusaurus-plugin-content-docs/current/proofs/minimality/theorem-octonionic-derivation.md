...
Трек A доказывает *число*; Трек B доказывает *структуру* $N=7$-системы; октонионное замыкание подтверждает, что они — одно согласованное целое. (Трек B — **не** второй независимый вывод числа: его Шаг T8 берёт $N = 7$ на вход; что он выводит независимо — что семимерная система вынуждена быть Фано/октонионной.) Мост **[Т]** — [полностью замкнут](#мост).
:::
