...
**Быстрое предравновесие (квазистационарное состояние).** Когда основной узел уравновешивается быстро относительно масштаба регенерации, $E$-канал достигает квазистационарной **заселённости ветвления** относительно $O$,
...
Это стандартная псевдо-первого-порядка (типа Михаэлиса–Ментен) скорость для двухканального процесса ветвления — билинейна по двум связям, обратно пропорциональна резиденции основания. (Проверено численно: быстрое предравновесие воспроизводит $\gamma_{OE}\gamma_{OU}/\gamma_{OO}$; циклический поток King–Altman — нет.)
