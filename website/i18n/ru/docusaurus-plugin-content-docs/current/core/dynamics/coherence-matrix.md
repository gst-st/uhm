...
{/* 21 названий/смыслов когерентностей выше рендерятся из единого источника
    src/data/coherences.ts — общего с матрицей на главной странице, так что они
    не могут разойтись. Редактировать названия/смыслы следует там. */}
