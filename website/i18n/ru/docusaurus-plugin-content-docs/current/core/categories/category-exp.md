...
- На $\Delta^{N-1}$ (спектры): **метрика Фишера** — индуцирована Бюрес на диагональных матрицах, с явно выписанным множителем: $g_{\mathrm{B}}|_{\Delta}=\tfrac14\operatorname{diag}(1/\lambda)=\tfrac14\,$Фишера–Рао (поскольку $\mathcal F_{\mathrm{SLD}}=4g_{\mathrm{B}}$)
