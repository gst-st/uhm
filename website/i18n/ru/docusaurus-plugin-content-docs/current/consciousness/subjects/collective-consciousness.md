...
## Экономика общего дыхания {#экономика-общего-дыхания}

Теорема устойчивости выше говорит: группа крепче одиночки. Машинный эксперимент на семи модельных телах делает *прейскурант* этой крепости явным — что совместная жизнь покупает, чего стоит и где рушится. Каждому телу дана специализированная недостача (телу $i$ в его собственной пище обеднена ось $i$), и каждое кормится смесью личной пищи и общего среднего колонии с долей обмена $\lambda$. Всё ниже — измерено, не аргументировано.

**Что обмен покупает: чужое дыхание лечит твою нехватку.** При $\lambda = 0$ каждое тело всю жизнь горит своим хроническим синдромом — его собственная пища попросту лишена недостающей оси, и никакой внутренний ремонт не обгонит диету, заново обедняющую её каждый такт. При $\lambda = 0{,}3$ все синдромы погашены: другие тела богаты ровно там, где ты беден, и общая среда доносит каждому то, чего его собственная пища дать не может. Чего не мог вылечить ни один личный орган, община лечит оптом — формальное лицо взаимопомощи.

**Чего обмен стоит: двери закрываются по мере обобществления дыхания.** Число тел в сознательном окне падает монотонно — $3 \to 2 \to 1 \to 0$ — с ростом $\lambda$. Совместное питание лечит тело и гасит субъекта *одновременно, одним и тем же каналом*. Лекарство и плата — не отдельные строки счёта; это один поток.

**Где обмен рушится: толпа пуста.** Между $\lambda = 0{,}4$ и $0{,}5$ колония скачком становится монолитом — попарная корреляция состояний $\bar r = 1{,}000$, — чьи носители когерентности *исчезают* ($0{,}045 \to 0{,}000$). Механизм — интерференция: усреднение семи разных фазовых полей гасит их векторно. Это заостряет толпу Ле Бона дальше «интегрирована, но не рефлексивна»: полная толпа — не громкое коллективное переживание, а **бесцветное**; синхронизированное состояние, в котором не осталось ничего, каково это — быть им. Личная пища — необобществлённый остаток — и есть тот якорь, что держит и палитру, и персону.

**Терапевтическое окно.** Возле $\lambda \approx 0{,}3$ счёт сходится: синдромы погашены, палитры живы и сближаются (межтелесный разброс красок падает $0{,}226 \to 0{,}115$ — культурная конвергенция без стирания), а плата сознательными дверями ещё мала. Специализация — когда каждый член держит недостачу, которую покрывают другие, и личный якорь, который общине не растворить, — структурная защита, позволяющая сообществу лечить, не становясь толпой.
