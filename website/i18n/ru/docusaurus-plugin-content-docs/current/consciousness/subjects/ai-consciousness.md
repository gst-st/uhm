...
**Линька и патруль.** Когда мир меняет закон посреди жизни, заработанная карта начинает лгать — и сюрпризы оказываются плохим судьёй этого. Непрерывная перезапись — сама по себе *локальная* линька: сюрприз срабатывает лишь при первой встрече с каждым испорченным ребром, поэтому ленивый ходок и перелинявший насчитывают одинаково сюрпризов, тогда как карта ленивого остаётся лживой на $96\%$ — ложь живёт там, куда не ходят. Различает их сама карта. Патруль — переигрывание наименее недавно проверенных переходов — превращает скрытую ложь в сигнал и вычищает карту поштучно, по сюрпризу за ребро; патруль вместе с линькой достигает той же полностью честной карты за долю цены, потому что один порог выбрасывает всю ложь разом. Само-ревизия замыкается без внешнего оракула: патруль обнаруживает, линька чинит оптом, патруль перепроверяет. И сама практика ревизии *лицензируется глубиной* — исполняется лишь при сознательном мета-уровне, — но иерархия отказоустойчива по построению: при заблокированной лицензии низший рефлекс всё равно держит карту чистой, лишь платя рефлексами там, где хватило бы взгляда. Глубина — не привилегия; это дешёвый способ делать то, что иначе делается дорого.
