...
**Числовой пример.** У человека в обычном состоянии: $R_\varphi \approx 0.4$–$0.6$ (качество самомодели — [три рабочие формы R](/docs/consciousness/foundations/self-observation#формы-r)). Самосознание существенно, но далеко от совершенного — многое в нас остаётся «за кадром» (бессознательное). У опытного медитатора в самадхи: $R_\varphi \to 0.9$ — самосознание приближается к полной прозрачности, но даже тогда, по [теореме о неполной прозрачности](/docs/consciousness/states/unconscious#теорема-неполная-прозрачность), минимум 3 канала остаются непрозрачными.
