...
калибровочно инвариантный, тождественно нулевой всякий раз, когда фазовое поле есть кограница (состояние, перефазируемое в вещественное — машинно там $|v|=0$, $|A|=0$ при выживающем $|S_0|=0{,}3446$), и гибнущий вместе с фазами со скоростью декогеренции $5\gamma/21$ (T-59). Это и есть точный объект за «декодированием семимерных когерентностей»: семь калибровочно инвариантных чисел, по одному на прямую таблицы умножения.
