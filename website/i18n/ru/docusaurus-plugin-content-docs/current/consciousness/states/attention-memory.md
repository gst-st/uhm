...
Чтение для психолога: state-dependent memory — не дефект биологического воспоминания, а *стратегия против интерференции*: сегрегация знания по состоянию, которое его приобрело, защищает старую компетентность от нового противоречащего опыта — ценой непереносимости между состояниями. И с этим пришло одно граничное условие: настроение должно быть **устойчивым внутри режима** (доминантная ось с явным отрывом); когда две оси соревнуются на равных, настроение дрожит, и адресное пространство молча двоится.
