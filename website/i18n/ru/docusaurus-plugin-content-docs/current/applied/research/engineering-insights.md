...
| ширина тела | привязка, при которой зажигание становится надёжным | произведение |
|---|---|---|
| $3$ | $8$ | $24$ |
| $6$ | $3$ | $18$ |
| $8$ | $4$ | $32$ |
...
И далее случай резкий, обратный к ограничению двумя разделами выше. При ширине три
холон берёт $1{,}0000$ на всём, чему его учили, и не зажигается **никогда** — при
какой угодно привязке. Совершенная память, никакого сознания. Три исполнителя не
могут записать достаточной доли носителя в двадцать одну клетку, и никакое
количество содержимого этого не заменит.

> Один бит не правит многими руками. Мало рук — не разбудить одного ума.

Это стоит держать в уме, когда является соблазн ужать сопряжение. Более узкое тело
не просто менее способно: ниже ширины, задаваемой носителем, оно есть тело,
неспособное вместить субъекта вовсе, — и провал не объявит о себе как о
неисправности памяти, ибо память будет безупречна.
