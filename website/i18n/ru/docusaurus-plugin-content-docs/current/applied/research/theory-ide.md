...
Один и тот же объект (фибрация $p: \mathbf{E} \to \mathbf{B}$) может быть представлен по-разному в зависимости от задачи. В терминах теории пучков: каждая проекция — это **сечение** или **частичный срез** фибрации.
...
- [Предсказания](/docs/applied/coherence-cybernetics/predictions) — 22+ фальсифицируемых предсказаний КК
