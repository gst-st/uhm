...
и достигается ровно в максимально смешанном состоянии $I/7$. Проверено машиной двумя путями (`internal/vanchurin-bridge/normalization_audit.py` §D–§E): прямым конечно-разностным вычислением тензора Римана в карте Гелл-Манна и по замкнутой форме Диттмана. Оба совпадают, а замкнутая форма воспроизводит постоянную $24$ при $N=2$ и $164$ при $N=3$.
