...
2. **Мудрость возвращается степенью, не ступенью.** Бинарный гейт «дегустируй, пока сознателен» проваливается (сытое тело сознательно почти всегда — ворота стоят открытыми). *Кредитный* гейт работает: каждый такт копится $\mathrm{clamp}(\Phi - 1, 0, 1)$, дегустация стоит единицу. Осторожность становится пропорциональной *богатству сознания*; бедный запасом пробует редко, порог — никогда. Это первая политика стека, где $\Phi$ — мера интеграции — действительно рулит, и она возвращает большую часть точности мудреца при полной устойчивости дома.
