...
Честность статусов: сигнатурная теорема — [Т]; сам словарь — отождествление с (работа, тепло, вещество) и с $(A, T, \mu)$ SLU — интерпретация [И], точная на сигнатурах и счёте. По *динамическим законам* реестр теперь таков: канал вещества **выведен** — регенерация есть в точности BKM-натурально-градиентный спуск свободной энергии $D(\rho_*\|\Gamma)$ ([T-261](/docs/core/dynamics/evolution#теорема-регенерация-градиентный-спуск)), квантово-информационный экземпляр ковариантного градиентного спуска SLU; компактность калибровочного тора выведена ([T-260](/docs/core/operators/lindblad-operators#теорема-происхождение-тора)); ноги работы и тепла остаются структурными [И].
