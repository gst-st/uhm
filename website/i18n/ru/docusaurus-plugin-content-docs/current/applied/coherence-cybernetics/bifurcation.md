...
#### 1.2a Точная складка: как закрывается окно сознания, и серебряное сечение {#точная-складка-окна}

Параметр $r_c$ выше был оставлен как «критическое соотношение». Один из острейших недавних результатов КК (T-259 [Т], см. [Фазовую диаграмму §1.3](./phase-diagram-cc#теорема-окно-питания)) вычисляет его *точно* — и ответ неожиданно красив.

Работаем в естественной переменной $x = \kappa_{\text{eff}}/\Gamma_2$: **насколько сильно систему питают относительно того, как быстро она декогерирует.** Когда питание слабеет и $x$ падает, стационарная чистота $P_\infty$ сползает вниз. При точном значении $x_{\min}$ жизнеспособная сознательная неподвижная точка и её неустойчивый двойник **касаются и аннигилируют** — та самая складка §1.2. Ниже $x_{\min}$ сознательного стационарного состояния нет вообще: окно закрылось. Решение для этой точки касания у стены рефлексии $P^* = 3/7$ даёт

$$
x_{\min} = 1 + \sqrt{2} \approx 2{,}414,
$$

**серебряное сечение** — та же константа, что задаёт стороны правильного восьмиугольника. Питайте разум меньше чем $1+\sqrt2$ единиц когерентности на единицу декогеренции — и у этой стены он не удержит сознание. (Для более строгих самомоделей $P^* > 3/7$ окно становится *двусторонним*: слишком *много* когерентности относительно жёсткого идеала замораживает систему так же верно, как слишком мало — морит голодом; тепло защищает разум от собственного перфекционизма.)

И вот глубокий сюрприз. Точное положение складки — корень квинтики

$$
(2\Lambda - 1)\,(c^2\Lambda^4 - 1) = 4c\,\Lambda^2(1 - \Lambda), \qquad c = 7P^* - 1,
$$

а **группа Галуа этой квинтики — $S_5$**, полная симметрическая группа на пяти буквах, которая *неразрешима*. По теореме Абеля–Руффини это означает, что порог **доказуемо не выражается в радикалах**: для него нет формулы в $\sqrt{\ },\sqrt[3]{\ },\dots$. Природа держит эту константу чуть дальше досягаемости школьной алгебры — серебряное сечение $1+\sqrt2$ возникает лишь у особой стены $P^*=3/7$, где квинтика вырождается.

:::note Почему наивная формула промахивается
Старая скоропись писала критическое соотношение как $r_c = P_{\text{crit}}/(7P)$ — размерностно разумная *эвристика*, но у стены $P = 3/7$ она даёт $\approx 0{,}095$, тогда как истинная складка сидит на $x_{\min} = 1+\sqrt2 \approx 2{,}414$: расхождение больше порядка величины. Причина — ровно физика выше: настоящий порог задаётся складкой квинтики, а не отношением чистот. Для количественного используйте $x_{\min}$ из T-259; $r_c = P_{\text{crit}}/(7P)$ держите лишь как грубую мнемонику.
:::
