...
**Величина** дрейфа на е-фолд (эквивалентно, скорость релаксации вакуума в хаббловских единицах) *не выведена* — как и величина самой Λ, она data-bound и есть в точности неизвестное H1.2; T-254 фиксирует *структуру* (какой функционал дрейфует, с каким показателем, к какому полу), T-255 — допустимые *формы*. Коэффициент со-дрейфа $\chi$ — $O(1)$, но не вычислен точно. Прочтение перескока при $z \approx 0{,}4$ — [И]. Туннелирование между минимумами (старый механизм 3) остаётся неисследованной [П]-альтернативой.
:::
