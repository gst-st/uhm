...
| H3.1 | ΣQ1′: charts forced by intensionality? | III | [Г], **sharpened to one atom** (T-245) | $d_{\min}\geq3 =$ nondegeneracy (closed, T-244) $\wedge$ faithfulness; overload $\Rightarrow d_{\min}=2$ (proven), so *not* forced in general; the sole residual is faithfulness of the intrinsic grading on normalizing ($\tau=1$) fibers — everything else closed |
