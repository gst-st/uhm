...
| H3.4 | Natural Fano foundation | III | **naturalness answered** (T-243); selection [Г] | the frame is the canonical pivotal structure of the octonions ($\mathbb{O} = k_\varphi[(\mathbb{Z}/2)^3]$; seven axes with $e_g^2=-1$, gauge-invariant; lines $=$ associative $\mathbb{H}$) — natural, not designed; the residual is whether a *given* foundation's dynamics *selects* the $-1$ pivotal sign over $+1$ |
