...
| H1.2 | The Universe's stage $P$ neither derived nor measured | I | [Г] | Λ-deficit programme output or an independent cosmological estimator; by T-244 the stage is the frame's degree of anisotropy, so the estimator target is sharpened (cosmic anisotropy ↔ $P$) — the floor's sharpest open edge, and the residue of H1.3 |
