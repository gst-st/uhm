...
Тензорная структура C^7 ⊗ C^6 (color на одном факторе, electroweak на другом) формально несовместима с SM-представлениями, в которых кварки несут одновременно цвет И слабый изоспин: (3,2)_{1/6}. Воспроизведение правильных SM-представлений из 42D формализма — **открытая проблема** [П]. Текущий ранг-4 результат является **структурным** (алгебра содержит достаточно генераторов), но **представительская** эквивалентность не доказана.
:::
