...
Эмерджентная природа пространства-времени в УГМ. Читатель узнает, как метрика отражает структуру различений матрицы когерентности $\Gamma$.
:::
...
В **классическом** случае метрика Фишера-Рао действительно является единственной (с точностью до нормировки) монотонной римановой метрикой на симплексе вероятностных распределений — теорема Ченцова (1982). Однако в **квантовом** случае эта уникальность нарушается: по теореме Петца (1996), на $\mathcal{D}(\mathcal{H})$ существует целое **семейство** монотонных метрик, параметризованных операторно-монотонными функциями $f$. SLD-метрика Фишера (приведённая выше) — лишь один из членов этого семейства.
...
Это и есть привилегированное положение метрики Бюреса в информационной геометрии: она является наименьшей из всех статистически допустимых метрик на пространстве квантовых состояний.
