...
:::warning Условный статус [С]
Доказательство N_gen=3 содержит два условных шага: (1) верхняя граница ≤3 из swallowtail A₄ — [С при топологии Gap-потенциала]; (2) нижняя граница ≥3 из (1,2,4)⊂Z₇* — тождественно истинно для триплета, но **отождествление элементов триплета с физическими поколениями** — [И]. Обновлённый статус: **[С при Fano-generation identification]**.
:::
