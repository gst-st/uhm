...
**Статус:** [С] — числовое согласие $\approx 0.17\text{–}0.20$ vs 0.17 (наблюдение) с двухпетлевой RG. Формула T-63 **[Т]**; прецизионное предсказание — вычислительная задача.
...
| $m_2/m_3$ | O-секторная Юкавская + 2-loop RG | $\approx 0.17\text{–}0.20$ | $0.17$ | **[С]** $\times 1.0\text{–}1.2$ |
...
1. **Расхождение $m_2/m_3$** — **решено [С]**: O-секторная Дираковская Юкавская сокращает расхождение с $\times 50$ до $\times 1.8$ (однопетлевой RG), затем до $\times 1.0\text{–}1.2$ с двухпетлевой RG. Формула T-63 **[Т]**; прецизионное предсказание — вычислительная задача в $\theta^*$. См. [§4.3](#теорема-отношение-нейтринных-масс).
