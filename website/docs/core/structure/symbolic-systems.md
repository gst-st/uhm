...
После анализа более десяти символических систем из разных эпох и культур напрашивается вопрос: существует ли **единый** формализм, который содержит всё, что описывают все эти системы? Ответ — да, и этот формализм — матрица когерентности $\Gamma$.
