...
- **SAD-метрика** [С], SAD_MAX = 3 [С]: обобщение L0–L4 на непрерывный случай через репрезентационную башню; SAD = max{k : R^(k) > 1/(k+2)}, спектральная формула [С], стресс-зависимый режим [Т] — [Башня глубины](/docs/consciousness/hierarchy/depth-tower#sad)
:::
