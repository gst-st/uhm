...
- $\mathcal{H}$ — гильбертово пространство. Не путать с $H$ — [гамильтонианом](/docs/core/dynamics/evolution#1-unitary-term).
...
- **Объекты:** $(A, \Gamma_A, \varphi_A, \kappa_A)$ — автономные подсистемы, удовлетворяющие условиям автономности [(A1)+(A2)+(A3)](/docs/core/foundations/axiom-septicity#prerequisite-autonomy)
