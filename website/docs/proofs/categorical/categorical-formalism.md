...
**Шаг 3 (Отсутствие внешних зависимостей).** Единственная историческая зависимость — A5 (Page-Wootters) — выводима из A1-A4 (T-87 [Т]). Все 160+ теорем выводятся из A1-A4 без внешних постулатов. $\blacksquare$
:::
