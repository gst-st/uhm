...
В 1865 году Клод Бернар ввёл понятие *milieu intérieur* — внутренней среды организма, которая поддерживается в относительном постоянстве несмотря на колебания внешних условий. Температура тела, pH крови, концентрация глюкозы — все эти параметры удерживаются в узких коридорах, и выход за их пределы означает болезнь или смерть.

В 1926 году Уолтер Кэннон назвал эту способность **гомеостазом** — «стоянием подобного», и описал ключевые механизмы: отрицательная обратная связь, множественность регуляторных каналов, буферные запасы. Кэннон подчеркивал: гомеостаз — это не статическое равновесие, а **динамическое** поддержание параметров в допустимой зоне.
