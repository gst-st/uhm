...
| Время $\tau$ | Аксиома Page-Wootters | [Т] |
...
### Аксиома 5: Page-Wootters — Время эмерджентно
...
Проблема Розена: его формализм остался на уровне категорий множеств и отображений. Он не мог описать **внутренний опыт**, **интеграцию** и **различение уровней сознания**.
