...
| Бейтсон | КК |
|---------|-----|
| Различие, порождающее различие | $\sigma_k = \text{clamp}(1 - 7\gamma_{kk}, 0, 1)$ — стресс как различие между состоянием и нормой |
...
| Фальсифицируемость | Трудна ($\Phi$ NP-труден) | Дискуссионна | Средняя | [22+ предсказания](/docs/reference/predictions) |
...
| Предсказания | Нет | [22+ фальсифицируемых](/docs/reference/predictions) |
...
1. **Эмпирическая верификация.** Кибернетики I-III были по преимуществу концептуальными: они меняли *способ мышления*, но не генерировали специфических экспериментальных предсказаний. КК делает шаг вперёд — [22+ фальсифицируемых предсказания](/docs/reference/predictions) — но большинство из них ещё ожидают проверки.
...
- [Предсказания](/docs/reference/predictions) — фальсифицируемые следствия КК
