...
1. **Real structure $J$.** The KO-dim 6 spectral triple has $J^2 = +1$, $J\chi = -\chi J$, where $\chi = \mathrm{diag}(+1,-1,-1,-1,+1,+1,+1)$ is the grading (T-53 [T]).
...
3. **Even potential.** The dissipation–regeneration balance $\mathcal{L}_\Omega + \mathcal{R}$ is $G_2$-covariant (T-62 [T]) and inherits $\sigma$-invariance from the real structure. Every odd-degree coupling $c_{2k+1} m^{2k+1}$ in the effective Landau potential must vanish by $\sigma$-symmetry.
