...
(при $\delta P_f$ фиксированном, финальная стадия определяется $\kappa_0$-усилением). Показатель масштабирования — $(\delta P)^{-1}$, а не $(\delta P)^{-1/2}$ (ранее заявленный). $\blacksquare$
