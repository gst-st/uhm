...
### 3.5 Критическая чистота для SAD [С] {#критическая-чистота-sad}

:::tip Теорема (Критическая чистота для глубины SAD) [С при спектральной формуле SAD]
...
Статус: **[С при спектральной формуле SAD]** — зависит от спектральной формулы SAD [С] (§3.4) и Fano contraction $\alpha = 2/3$ [Т] (T-110).
