...
14. Knowledge passes **at second hand** without loss when the teacher is good (student calibration lands bit-identically on truth's) — but provenance must separate echo from observation: a teacher's blind claims are his prior in copies, and the filter buys independence, not accuracy
