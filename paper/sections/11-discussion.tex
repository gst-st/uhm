...
\begin{enumerate}[leftmargin=2em]
  ...
  \item \textbf{Derives all five axioms (quadruple Bures characterization).}
        T-186 upgrades the phenomenal functor to structural necessity. T-187 proves
        Bures canonicity via triple characterization, strengthened to a
        \emph{quadruple} by T-189~\status{T} (MaxEnt covariance Char-IV).
        T-190~\status{T} (Axiomatic Closure) proves that all axioms are theorems:
        zero free parameters, zero independent postulates.
