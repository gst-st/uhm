...
potential is not imposed but derived. The dissipation--regeneration balance (covariant under the octonionic frame
group $\Gamma_{\mathrm{oct}} = \mathrm{Aut}(\mathrm{PG}(2,2)) \cong \mathrm{PSL}(2,7)$)
is invariant under the canonical involution
