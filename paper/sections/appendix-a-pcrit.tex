...
\begin{enumerate}[leftmargin=2em,nosep]
  \item The holon Hilbert space is $\Hil = \mathbb{C}^7$ (Axiom A3 in
    ...
    minimality is given in Appendix~\ref{app:minimality-hint} and is not used
    in this appendix).
...
Appendix~\ref{app:minimality-hint}).
...
\begin{enumerate}[leftmargin=2em,nosep]
  ...
  \item The reference state is the maximally mixed state $I/7$
    (justified independently in Section~\ref{subsec:reflection-canonicity}
    and Appendix~\ref{app:rcanon}: $I/7$ is the unique
...
\begin{itemize}[leftmargin=2em,nosep]
  ...
  \item No reliance on the website, on other documents of the project, or
    on results labeled ``[И]'' (interpretation).
  \item The statement ``$I/7$ is the canonical reference'' is used only in
    ...
    (Appendix~\ref{app:rcanon}, Theorem R.2); all other routes (A.1, A.2, A.3)
