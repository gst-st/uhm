...
T-149 \status{T} (Fano plane minimality), T-82 \status{T}
(BIBD$(7,3,1)$ uniqueness via Fisher--Veblen--Wedderburn), T-42a
\status{T} ($G_2$-rigidity), T-120 \status{T}
($M^4 = \mathbb R \times \Sigma^3$), T-151 \status{T}
($\Dmin = 2$), T-190 \status{T} (zero-axiom closure); the 12-step
Bridge~T-15 chains them without parameter freedom.
