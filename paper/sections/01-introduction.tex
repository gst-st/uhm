...
(T-87~\status{T}). Crucially, all four axioms are themselves derived as
theorems (T-186, T-187, T-189, T-190~\status{T}), making UHM
\emph{self-grounding}: zero independent axioms remain beyond the defining
properties of viable holons. From this foundation, over 190 theorems follow,
including:
