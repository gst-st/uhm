...
The complete formalization (over 180 theorems with proofs) is documented in the
companion online supplement, with all proofs that exceed the present scope detailed
there. The present paper is self-contained for its principal results: the appendices
